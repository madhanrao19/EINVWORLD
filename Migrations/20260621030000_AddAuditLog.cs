...
namespace eInvWorld.Migrations
{
    ...
    public partial class AddAuditLog : Migration
    {
        ...
        {
            // Tamper-evident, append-only audit trail. Each row carries PreviousHash (the prior row's
            // RowHash) and RowHash (a SHA-256 of its own content chained onto PreviousHash), so the
            // chain can be recomputed to prove no row was inserted, deleted, or edited.
