...
namespace eInvWorld.Models.InputModel
{
    public class Buyer
    {
        ...
        [StringLength(300, ErrorMessage = "Buyer's Name cannot exceed 300 characters.")]
        [Display(Name = "Buyer Name")]
        public string Name { get; set; } = null!;

        [Required(ErrorMessage = "Buyer's TIN is required.")]
        [StringLength(14, ErrorMessage = "Buyer's TIN must be 14 characters.")]
        ...
        [Required(ErrorMessage = "Buyer's Registration/Identification Number is required.")]
        [Display(Name = "Registration / Identification / Passport Number")]
        public string RegistrationIdentificationNumber { get; set; } = null!;

        [StringLength(35, ErrorMessage = "Buyer's SST Registration Number cannot exceed 35 characters.")]
        [Display(Name = "SST Registration Number")]
        public string? SSTRegistrationNumber { get; set; }

        [StringLength(17, ErrorMessage = "Buyer's Tourism Tax Registration Number cannot exceed 17 characters.")]
        [Display(Name = "Tourism Tax Registration Number")]
        public string? TourismTaxRegistrationNumber { get; set; }

        [EmailAddress(ErrorMessage = "Invalid Email Address.")]
        [StringLength(320, ErrorMessage = "Buyer's Email cannot exceed 320 characters.")]
