...
namespace eInvWorld.Pages.Invoices
{
    ...
    public class InvoiceEditModel : SupplierBasePage
    {
        ...
        //    // Load all dropdown options for new invoice mode
        //    ClassificationCodes = _dropdownHelper.GetClassificationCodeOptions();
        //    UnitOptions = _dropdownHelper.GetUnitOptions();
        //    TaxCategoryOptions = _dropdownHelper.GetTaxCategoryOptions();

        //    // Debug: Log dropdown data counts
        //    Console.WriteLine($"[DEBUG] ClassificationCodes count: {ClassificationCodes?.Count ?? 0}");
        //    Console.WriteLine($"[DEBUG] UnitOptions count: {UnitOptions?.Count ?? 0}");
        //    Console.WriteLine($"[DEBUG] TaxCategoryOptions count: {TaxCategoryOptions?.Count ?? 0}");

        //    // Debug: Log classification codes to see if 004 exists
        //    if (ClassificationCodes != null)
        //    {
        //        Console.WriteLine("[DEBUG] Available Classification Codes:");
        //        foreach (var code in ClassificationCodes.Take(10))
        //        {
        //            Console.WriteLine($"  - Value: '{code.Value}', Text: '{code.Text}'");
        //        }

        //        var code004 = ClassificationCodes.FirstOrDefault(c => c.Value == "004");
        //        Console.WriteLine($"[DEBUG] Classification code '004' exists: {code004 != null}");

        //        if (code004 != null)
        //        {
        //            Console.WriteLine($"[DEBUG] Code 004 details - Value: '{code004.Value}', Text: '{code004.Text}'");
        //        }
        //    }
        ...
        //    string classificationCode = "022"; // Default classification for new invoices

        //    if (Invoice != null && new[] { "11", "12", "13", "14" }.Contains(Invoice.DocTypeCode))
        //        classificationCode = "004"; // Self-billed documents must use 004

        //    // Only create new invoice if not loading existing one
        //    if (Invoice == null)
        //    {
        ...
        //        };
        //    }
        //    else if (Invoice.InvoicePeriod == default)
        //    {
        ...
        //        {
        //            Console.WriteLine("[INFO] Self-Billed Invoice detected. Switching Supplier and Buyer.");
        ...
        //                Console.WriteLine($"[INFO] Assigned General TIN as Supplier: {generalTIN.TIN} - {generalTIN.CompanyName}");
        //            }
        //            else
        //            {
        //                Console.WriteLine("[WARNING] No General TIN found! Self-billed invoice may be invalid.");
        ...
        //            .Where(p => _context.SupplierBuyers.Any(sb =>
        //                        sb.SupplierId == Invoice.SupplierId &&
        //                        sb.BuyerId == p.PartyInfoId)
        //                     || p.TIN == "EI00000000010"
        //                     || p.TIN == "EI00000000020"
        //                     || p.TIN == "EI00000000040")
        //            .Select(p => new SelectListItem
        ...
        //    await LoadDropdownDataAsync(); // ✅ Async version applied here
        //    BankDetails = await LoadBankDetailsAsync();
