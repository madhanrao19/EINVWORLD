...
> | Post-migration — dark mode + skip-nav (2026-08-02) | ✅ merged | `_LayoutTabler`/`_LoginLayoutTabler` topbar dark-mode toggle (cookie-persisted, OS-preference default) and app-wide skip-navigation link (`_LayoutTabler`, `_LoginLayoutTabler`, `_HomeLayout`); `einvworld-tokens.css` dark-mode overrides matched to Tabler's own dark palette. See CHANGELOG 2026-08-02. |
