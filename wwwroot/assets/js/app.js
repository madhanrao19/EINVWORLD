!function () {
    ...
    var d = navbarMenuElement ? navbarMenuElement.innerHTML : ""
        , M = 7
        , t = "en"
        ...
        Array.from(document.querySelectorAll("input[name=" + n + "]")).forEach(function (a) {
            ...
            document.getElementById("collapseBgGradient") && Array.from(document.querySelectorAll("#collapseBgGradient .form-check input")).forEach(function (e) {
                ...
                1 == e.checked && new bootstrap.Collapse(t, {
                    ...
                    document.querySelector("[data-bs-target='#collapseBgGradient']") && document.querySelector("[data-bs-target='#collapseBgGradient']").addEventListener("click", function () {
    ...
    sessionStorage.getItem("defaultAttribute") ? ((h = {})["data-layout"] = sessionStorage.getItem("data-layout"),
        ...
        (z = document.querySelectorAll(".light-dark-mode")) && z.length && z[0].addEventListener("click", function () {
        ...
        document.getElementsByClassName("dropdown-item-cart") && (B = document.querySelectorAll(".dropdown-item-cart").length,
            ...
            F()),
        (function () {
            const notifChecks = document.querySelectorAll(".notification-check input");
            const dropdown = document.getElementById("notificationDropdown");

            if (notifChecks.length) {
                if (typeof H === "function") H();

                notifChecks.forEach((t) => {
                    t.addEventListener("change", function (e) {
                        e.target.closest(".notification-item")?.classList.toggle("active");
                        const count = document.querySelectorAll(".notification-check input:checked").length;
                        const actions = document.getElementById("notification-actions");
                        const sel = document.getElementById("select-content");
                        if (actions) actions.style.display = count > 0 ? "block" : "none";
                        if (sel) sel.innerHTML = count;
                    });
                });

                if (dropdown) {
                    dropdown.addEventListener("hide.bs.dropdown", function () {
                        notifChecks.forEach((t) => (t.checked = false));
                        document.querySelectorAll(".notification-item").forEach((e) => e.classList.remove("active"));
                        const actions = document.getElementById("notification-actions");
            ...
            const modalEl = document.getElementById("removeNotificationModal");
            if (modalEl) {
                modalEl.addEventListener("show.bs.modal", function () {
                    ...
                    delBtn.addEventListener(
                        "click",
                        function () {
                            document.querySelectorAll(".notification-item.active").forEach((el) => el.remove());
                            if (typeof H === "function") H();
